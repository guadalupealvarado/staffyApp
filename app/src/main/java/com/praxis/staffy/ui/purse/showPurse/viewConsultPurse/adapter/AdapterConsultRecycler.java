package com.praxis.staffy.ui.purse.showPurse.viewConsultPurse.adapter;
...
public class AdapterConsultRecycler extends RecyclerView.Adapter<AdapterConsultRecycler.ResourceViewHolder> {
    private ArrayList<InfoRecursoPurse> infoRecursoPurses;
    private int resourse;
    private ViewConsultPurseView activity;
    public AdapterConsultRecycler
            (ArrayList<InfoRecursoPurse> infoRecursoPurses, int resourse, ViewConsultPurseView activity) {
    ...
    @NonNull
    @Override
    public AdapterConsultRecycler.ResourceViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(resourse,parent,false);
        return  new AdapterConsultRecycler.ResourceViewHolder(view);
    }
