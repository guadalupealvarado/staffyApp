...
public class ViewPostulanPurseRepository extends PurseEventGeneral implements ViewPostulanPurseMVP.ViewPostulanPurseRepository {

    public final static String STATEEVENTBUSPURSE="PURSESHOW";
    private final AppiServicePurse appiServicePurse;

    public ViewPostulanPurseRepository() {
