package com.praxis.staffy.ui.requisition.newRequisicion.newRequisitionRecyclerView;
...
public class AdapterRequisition extends RecyclerView.Adapter<AdapterRequisition.RequisitionViewHolder>{
    ...
    public AdapterRequisition(ArrayList<perfil_requerido> perfilRequeridos, int resource, Activity activity) {
    ...
    @NonNull
    @Override
    public RequisitionViewHolder onCreateViewHolder(@NonNull ViewGroup parent,
                                                    int viewType) {
        View view = LayoutInflater.from(parent.
                getContext()).inflate(resource,parent,
                false);
    ...
    @Override
    public void onBindViewHolder(@NonNull RequisitionViewHolder holder,
                                 int position) {
